...
def build_dump_bundle(
    ...
    *,
    ...
    domoticz_use_signed_net_phase_power: bool = False,
    ...
    return {
        ...
        "domoticz": {
            ...
            "use_signed_net_phase_power": bool(domoticz_use_signed_net_phase_power),
...
def build_replay_snapshot(
    ...
    if isinstance(domoticz_block, Mapping):
        ...
        use_signed_net_phase_power = bool(domoticz_block.get("use_signed_net_phase_power", False))
    ...
    return DomoticzUsageSnapshot(
        ...
        use_signed_net_phase_power=use_signed_net_phase_power,
    )
